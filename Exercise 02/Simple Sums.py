...
first_number = 8   # Set first_number to 8
second_number = 10   # Set the second number to 10
sum_of_numbers = first_number + second_number   # Adding the two numbers and storing the result
